...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "drill", "symbols": ["drill", "_", (lexer.has("drill_arrow") ? {type: "drill_arrow"} : drill_arrow), "_", "bit"], "postprocess": p.drill},
    ...
    {"name": "drill", "symbols": ["drill$ebnf$1", "bit"], "postprocess": p.drillContext},
